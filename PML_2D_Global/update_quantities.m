function [P_past,vect_epsi_n_2,vect_epsi_n,vect_sig_n,vect_Epsi_n,...
    vect_Sig_n] = update_quantities(G, dt,nn,dof,ng,Nef,global_pos_elemB,u...
...
P_past = zeros(nn*dof,1); % reset P_past to 0
...
switch ng
    case 2
        for i=1:Nef
            ...
            disp_ef = u(global_pos_elemB(:,i)); 
            % and velocity
            vit_ef = v(global_pos_elemB(:,i));
